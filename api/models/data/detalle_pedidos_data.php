...
require_once('../../models/handler/detalle_pedidos_handler.php');
/*
 *	Clase para manejar el encapsulamiento de los datos de la tabla PRODUCTO.
 *  Esta clase extiende de DetallePedidoHandler y añade validaciones y métodos específicos
 *  para manejar los datos relacionados con los detalles de pedidos.
 */
class DetallePedidoData extends DetallePedidoHandler
{
    ...
    public function setId($value)
    {
        ...
        // Método para establecer el ID del pedido, asegurando que es un número natural.
    public function setIdPedido($value)
    {
        if (Validator::validateNaturalNumber($value)) {
            ...
            $this->data_error = 'El identificador del modelo es incorrecto';  // Si no es válido, guarda un mensaje de error.
            return false;
        }
    }
        // Método para establecer el ID de la talla, asegurando que es un número natural.
    ...
    public function setNombre($value, $min = 2, $max = 50)
    {
        ...
        // Método para establecer la descripción, asegurando que es una cadena válida y dentro del rango de longitud permitido.
